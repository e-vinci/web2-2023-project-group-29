...
const PRODUCTION_API_BASE_URL = 'https://remember-or-die-api.azurewebsites.net/'; // to be changed to point to the URL of your API
...
const PRODUCTION_PATH_PREFIX = '/remember-or-die/'; // e.g. '/mymovies/' if you deploy to GitHub Pages as a Project site : mymovies would be the repo name
...
module.exports = {
  ...
  module: {
    rules: [
      ...
      {
        test: /\.(png|jpg|gif|svg|mp3|mpe?g|ico)$/,
        type: 'asset/resource',
      },
